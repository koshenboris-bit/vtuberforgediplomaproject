const translations = {
  en: {
    ...
    newsLabel: "Newsroom", newsTitle: "VNews", newsText: "A more interesting news layout with a featured update, then a feed of live cards.", featuredUpdate: "Featured update", newsUpdate: "Update", newsBulletin: "VTuberForge bulletin", newsLive: "Live", noNews: "No news yet.", noMoreNews: "No more news items yet.",
    ...
    profileLikedNewsTitle: "Liked news", profileLikedNewsCount: "liked item(s)", profileSavedNewsTitle: "Saved news", profileSavedNewsCount: "saved item(s)", profileOpenLikedNews: "Open liked news", profileOpenSavedNews: "Open saved news", profileNewsCommentsTitle: "Your news comments", profileNewsCommentsCount: "comment(s)", profileNoLikedNews: "No liked news yet.", profileNoSavedNews: "No saved news yet.", profileNoNewsComments: "No comments yet.", profileNewsComment: "News comment",
  ...
  ru: {
    ...
    newsLabel: "Новости", newsTitle: "VНовости", newsText: "Главный апдейт и карточки свежих новостей.", featuredUpdate: "Главное обновление", newsUpdate: "Обновление", newsBulletin: "Бюллетень VTuberForge", newsLive: "Live", noNews: "Новостей пока нет.", noMoreNews: "Больше новостей пока нет.",
    ...
    profileLikedNewsTitle: "Понравившиеся новости", profileLikedNewsCount: "лайк(ов)", profileSavedNewsTitle: "Сохраненные новости", profileSavedNewsCount: "сохранено", profileOpenLikedNews: "Открыть лайки", profileOpenSavedNews: "Открыть сохранёнки", profileNewsCommentsTitle: "Твои комментарии", profileNewsCommentsCount: "комментариев", profileNoLikedNews: "Нет понравившихся новостей.", profileNoSavedNews: "Нет сохраненных новостей.", profileNoNewsComments: "Комментариев пока нет.", profileNewsComment: "Комментарий к новости",
  ...
  kk: {
    ...
    newsLabel: "Жаңалықтар бөлімі", newsTitle: "Vжаңалықтары", newsText: "Негізгі жаңарту және тірі карточкалар ағыны.", featuredUpdate: "Негізгі жаңарту", newsUpdate: "Жаңарту", newsBulletin: "VTuberForge бюллетені", newsLive: "Тікелей эфир", noNews: "Жаңалықтар әлі жоқ.", noMoreNews: "Басқа жаңалықтар әлі жоқ.",
